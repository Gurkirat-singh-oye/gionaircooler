...
function ContactUs(params) {
  return (
    <div className={` ${ params?.isHomePage ? `` : ` -mt-[70px] lg:-mt-[120px]`} pb-32 sm:pb-0 bg-gion-powder-blue `}>
      <div className={` ${ window?.innerWidth < 1024 ? ` pt-16 ` : `` } lg:p-32 flex flex-col gap-8 lg:gap-0 lg:flex-row items-center lg:justify-between `}>
        <div className=" pt-14 lg:pt-0  w-[80%] lg:w-[50%] flex flex-col gap-1 lg:gap-6 items-center lg:items-start text-center lg:text-start ">
        ...
        <div className=" w-[80%] lg:w-[40%] flex flex-col gap-8 items-center lg:items-start text-start ">
          <div className={` w-full flex flex-col gap-3 `} >
            ...
            <input className=" px-3 py-2 lg:py-1 w-full lg:w-[85%] text-xs lg:text-4xl rounded-full border border-gion-teal bg-[#EBF4FF] " />
          </div>
          <div className={` w-full flex flex-col gap-3 `} >
