...
const ProductSpecificationsPage = (params) => {
  ...
  async function getProductSpecs() {
    let { data: product } = await supabase.from("products").select().eq('name', productslug);
  ...
  const specs = [
    ...
    { label: "Air Throw Distance", value: `${pageProductSpecs?.air_throw} Feet` },
    { label: "Power Consumption", value: `${pageProductSpecs?.power_consumption} Watts` },
  ...
  return (
    pageProductSpecs && <div className=" w-full flex flex-col ">
      {/** product intro section */}
      <div className=" py-16 w-full flex flex-col lg:flex-row gap-8 lg:gap-12 justify-center bg-gion-powder-blue">
        ...
        <div className="flex flex-col justify-start w-full lg:w-1/2 gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className=" flex flex-row gap-2 ">
              <FeatureBubble feat={`${pageProductSpecs?.water_tank_capacity}L`} />
              <FeatureBubble feat={pageProductSpecs?.type} />
              <FeatureBubble feat={"Inverter"} />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className=" flex flex-col gap-10 ">
              <div className=" flex flex-row gap-2 ">
                <img />
                <div className=" text-sm ">somsomsosmosmsomsom</div>
              </div>
              <div className=" flex flex-row gap-2 ">
                <img />
                <div className=" text-sm ">somsomsosmosmsomsom</div>
          ...
          {/* CTA Button */}
          <div className="w-full lg:w-[570px] flex flex-col gap-2 mt-8 pt-4">
            <Gbutton
          ...
          <table>
            <tbody>
              {specs.map((row, i) => (
                ...
                >
                  <td className="py-3 px-6 text-gray-500 w-1/2">{row.label}</td>
